...
// Tx returns a wrapped transaction (btgutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (btgutil.Tx) for all
...
// instead provides easy access to wrapped versions (btgutil.Tx) of them.
