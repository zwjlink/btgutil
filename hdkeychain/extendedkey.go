...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := btgutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*btgutil.AddressPubKeyHash, error) {
	pkHash := btgutil.Hash160(k.pubKeyBytes())
	return btgutil.NewAddressPubKeyHash(pkHash, net)
}
