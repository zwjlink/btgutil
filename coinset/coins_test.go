...
import (
	...
	"github.com/zwjlink/btgutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    btgutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() btgutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value btgutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = btgutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = btgutil.NewTxFromBytes(testSimpleCoinTxBytes)
